...
const ModuleList: ModuleItem[] = [
  {
    ...
    description: (
      <>
        Dive into the fundamentals of robotic control with ROS 2 and master URDF
        for robot modeling.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Explore advanced simulation techniques with Gazebo and Unity for
  ...
  },
  {
    ...
    description: (
      <>
        Unleash the power of AI with Isaac Sim for high-fidelity simulations and
  ...
  },
  {
    ...
    description: (
      <>
        Learn to integrate advanced AI for cognitive planning and speech
      ...
      <div className="text--center padding-horiz--md">
        ...
        <Link
          className={clsx(
            ...
            customElementStyles.mechaPanelButton,
          )}
          to={link}
        >
          Explore Module
